...
We randomly selected TODO INSERT NUMBER OF SEQUENCES subsequences of size TODO INSERT SIZE from the original time-series. 
A hierarchical clustering was then performed using the scipy.cluster.hierarchy.fcluster function, with the distance criterion. 
TODO INSERT NUMBER clusters were identified, and the most representative cluster was selected using the criterion described above.
The centroid of the cluster was then computed, and led to the following normal mode : TODO INSERT FIG. 
